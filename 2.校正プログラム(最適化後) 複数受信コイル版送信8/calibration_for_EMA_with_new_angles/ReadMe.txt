========================================================================
    コンソール アプリケーション: calibration_for_EMA_with_new_angles プロジェクトの概要
========================================================================

この calibration_for_EMA_with_new_angles アプリケーションは、AppWizard により作成されました。

このファイルには、calibration_for_EMA_with_new_angles 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


calibration_for_EMA_with_new_angles.vcxproj
...
calibration_for_EMA_with_new_angles.vcxproj.filters
...
calibration_for_EMA_with_new_angles.cpp
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、calibration_for_EMA_with_new_angles.pch 
